...
2. Under OAuth and Permissions, add the bot token scopes `chat:write`, `chat:write.public`, and `channels:read`.
3. Add `https://<your-api-host>/v1/slack/callback` to the app's redirect URLs.
4. Set the credentials on the API worker:
